...
class AboutArrays < Neo::Koan
  ...
  def test_arrays_and_ranges
    ...
    # .class returns primitive object
    # to_a converts params to an array
    # .. run from the beginning to the end inclusively including the last value
