...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    # https://apidock.com/ruby/Object/instance_variables
    # Returns an array of instance variable names for the receiver.

    fido = Dog2.new
    assert_equal [], fido.instance_variables # empty array because set_name hasn't been called to set name to instance variable
