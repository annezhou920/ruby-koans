...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject takes each element in an array and applies it to the value as the aggregator
    # inject takes a value to start with (the 0 in your example),
    # and a block, and it runs that block once for each element of the list.
  end
