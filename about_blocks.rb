...
class AboutBlocks < Neo::Koan
  ...
  def yield_tester
    if block_given?
      ...
      # The yield keyword — in association with a block — allows to pass a set of
      # additional instructions during a method invocation.
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    # &make_upper is the block's name
